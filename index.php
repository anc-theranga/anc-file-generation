...
// THOSE GRANTED PERMISSION TO DO ANY OF THE ABOVE WITH THIS WORK CANNOT GIVE, SELL, BEQUEATH OR TRANSFER IN ANY WAY THAT PERMISSION TO OTHERS.

$uri=replace('#','&',$_SERVER['REQUEST_URI']);
$nURL=vsprintf("Location: http://%s/%s",array($_GET['ip'],$uri));
